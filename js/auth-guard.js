    ...
    if (!userDiv) {
      ...
      userDiv.innerHTML = `
        <div id="userProfileCard" class="bg-white rounded-xl shadow-lg flex flex-col items-center py-4 px-3 mb-2 relative" style="min-width:180px;">
          ...
          <div class="text-xs text-green-600 font-semibold text-center">Branch: <span id='user-branch'>${branch}</span></div>
      ...
      card.querySelectorAll('div.text-xs')[1].innerHTML = `Branch: <span id='user-branch'>${branch}</span>`;
